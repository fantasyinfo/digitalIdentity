            ...
            <div class="col-lg-3 col-6">
              ...
              <div class="small-box bg-info">
                <div class="inner">
                  ...
                  <p>Total Tests Added</p>
                </div>
                <div class="icon">
                <i class="fa-solid fa-bars"></i>
                </div>
                <a href="<?= base_url('exam/allExams');?>" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
              </div>
            </div>
            ...
            <div class="col-lg-3 col-6">
              ...
              <div class="small-box bg-primary">
                <div class="inner">
                  ...
                  <p>Total Tests Results Published</p>
                </div>
                <div class="icon">
                <i class="fa-solid fa-list"></i>
                </div>
                <a href="<?= base_url('exam/allResults');?>" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
              </div>
            </div>
            ...
            <div class="col-lg-3 col-6">
              ...
              <div class="small-box bg-success">
                <div class="inner">
                  ...
                  <p>Today Tests Result Published</p>
                </div>
                <div class="icon">
                <i class="fa-solid fa-list"></i>
                </div>
