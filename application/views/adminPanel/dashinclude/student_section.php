...
$totalboys = $this->db->query("SELECT count(1) as count FROM " . Table::studentTable . " WHERE schoolUniqueCode = '{$_SESSION['schoolUniqueCode']}' AND status = '1' AND gender = '1'")->result_array()[0]['count'];

$totalgirls = $this->db->query("SELECT count(1) as count FROM " . Table::studentTable . " WHERE schoolUniqueCode = '{$_SESSION['schoolUniqueCode']}' AND status = '1' AND gender = '2' ")->result_array()[0]['count'];
            ...
            <div class="card-body">
                ...
                <div class="d-flex align-items-end justify-content-between mt-4">
                    <div>
                        ...
                        <a href="<?= base_url('academic/allAttendance'); ?>" class="text-decoration-underline">View all attendance</a>
                    </div>
    ...
    <div class="col-xl-6 col-md-6">
       ...
       <div class="card card-animate">
           <div class="card-body">
               ...
               <div class="d-flex align-items-end justify-content-between mt-4">
                   <div>
                       <h3 class="fs-22 fw-semibold ff-secondary mb-4"><span class="counter-value text-success" data-toggle="tooltip" data-placement="top" title="Girls"> <i class="fa-solid fa-child-dress"></i> <?= $totalgirls ?></span> <span class="counter-value text-danger" data-toggle="tooltip" data-placement="top" title="Boys"> <i class="fa-solid fa-child"></i> <?= $totalboys ?></span></h3>
                       <a href="<?= base_url('student/list'); ?>" class="text-decoration-underline">View all students</a>
                   </div>
