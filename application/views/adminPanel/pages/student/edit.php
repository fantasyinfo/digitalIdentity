                      ...
                      <div class="col-md-12">
                        <div class="row">
                          ...
                          <div class="form-group col-md-3">
                            ...
                            <input type="date" name="date_of_admission" class="form-control" id="date_of_admission" placeholder="Date of Admission" value="<?=  date('Y-m-d',strtotime($sd['date_of_admission'])); ?>">
                          </div>
                          <div class="form-group col-md-3">
                        ...
                        <div class="row">
                          <div class="form-group col-md-3">
                            ...
                            <input type="date" name="dob" class="form-control " id="dob" value="<?= date('Y-m-d',strtotime($sd['dob'])); ?>">
                          </div>
                          <div class="form-group col-md-3">
