                    ...
                    <div class="card-body">
                      <div class="col-md-12 mx-auto">
                        <form method="post" action="">
                          ...
                          <div class="form-group">
                            <input type="text" name="designationName" value="<?php if (isset($_GET['action']) && $_GET['action'] == 'edit') {
                                                                                echo $editCityData[0]['designationName'];
                                                                              } ?>" class="form-control" id="name" placeholder="Enter designation name" required>
                          </div>
                          <div class="form-group">
                    ...
                    <div class="card  border-top-3">
                      ...
                      <div class="card-body">
                        <div class="table-responsive">
                          ...
                          <table id="cityDataTable" class="table align-middle mb-0 bg-white">
