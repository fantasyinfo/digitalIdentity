        ...
        <div class="row">
          ...
          <div class="card">
              <div class="card-header">
                <h3 class="card-title">Showing All Teache's Attendance Data</h3>
...
<!-- ./wrapper -->
<script>
  var ajaxUrlForStudentList = '<?= base_url() . 'ajax/allTeachersAttendanceList'?>';
   // datatable student list intilizing
 loadStudentDataTable();

function loadStudentDataTable(tn = '',fd = '',td = '', as = '')
{
