            ...
            <div class="col-md-4 mx-auto">
              ...
              <div class="card border-top-3">
                <div class="card-header">
                  <h4><?php if (isset($_GET['action']) && $_GET['action'] == 'edit') {echo 'Edit Fees Master';}else{echo 'Add Fees Master';} ?></h4>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                  <form method="post" action="">
                    ...
                    <div class="row">
                      ...
                      <label>Fee Group <span style="color:red;">*</span></label>
                            <select name="newFeeGroupId" id="newFeeGroupId" class="form-control  select2 select2-danger" required data-dropdown-css-class="select2-danger" style="width: 100%;">
                      ...
                      <label>Fee Type <span style="color:red;">*</span></label>
                            <select name="newFeeType" id="newFeeType" class="form-control  select2 select2-danger" required data-dropdown-css-class="select2-danger" style="width: 100%;">
                      ...
                      <div class="form-group col-md-12">
                        ...
                        <input type="date" name="dueDate" value="<?php if (isset($_GET['action']) && $_GET['action'] == 'edit') {echo $editFeesHeadMasterData[0]['dueDate'];} ?>" class="form-control">
                      </div>
                      <div class="form-group col-md-12">
                        <label>Amount <span style="color:red;">*</span></label>
                        <input type="number" name="amount" value="<?php if (isset($_GET['action']) && $_GET['action'] == 'edit') {echo $editFeesHeadMasterData[0]['amount'];} ?>" class="form-control" required>
                      </div>
                      <div class="form-group col-md-12">
                      <label>Fine Type <span style="color:red;">*</span></label>
                            <select name="fineType" id="fineType" class="form-control  select2 select2-danger" required data-dropdown-css-class="select2-danger" style="width: 100%;" onchange="showHide()">
                              <!-- <option>Select Fee Type</option> -->
                              <?php
                               $selected = '';
                      ...
                      <div class="form-group col-md-6" >
                        ...
                        <input type="number" id="ffA" name="fineFixAmount" value="<?php if (isset($_GET['action']) && $_GET['action'] == 'edit') {echo $editFeesHeadMasterData[0]['fineFixAmount'];} ?>" class="form-control">
                      </div>
                      <div class="form-group col-md-6" >
                        <label>Percentage</label>
                        <input type="number"  id="fPA" name="finePercentage" value="<?php if (isset($_GET['action']) && $_GET['action'] == 'edit') {echo $editFeesHeadMasterData[0]['finePercentage'];} ?>" class="form-control">
                      </div>
                      <div class="form-group col-md-12">
  ...
  <div class="modal-dialog modal-dialog-centered" role="document" >
    ...
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <button type="submit" name="assignFeesToClass" class="btn btn-primary">Save</button>
      </div>
    </div>
      </form>
  </div>
